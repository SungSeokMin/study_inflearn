...
import LogoutButton from "@/app/(afterLogin)/_component/logoutButton/LogoutButton";
...
import RQProvider from "@/app/(afterLogin)/_component/reactQuery/RQProvider";
...
const AfterLoginLayout = async ({ children, modal }: AfterLoginLayoutProps) => {
